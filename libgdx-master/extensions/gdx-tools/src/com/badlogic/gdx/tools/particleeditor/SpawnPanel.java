		...
		shapeCombo.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent event) {
				...
				case square:
					...
					editor.setVisible("发射器宽度", true);
					editor.setVisible("发射器高度", true);
					break;
				case ellipse:
				...
				case point:
					setEdgesVisible(false);
					editor.setVisible("发射器宽度", false);
					editor.setVisible("发射器高度", false);
					break;
				}
			}
		});
